...
import { BarChart3, BookOpen, LayoutDashboard, Package, ShoppingBag, Star, LogOut } from 'lucide-react'
...
const navLinks = [
  ...
  { href: '/teacher/reviews', label: 'Отзывы', icon: Star },
]
    ...
    <div className="flex min-h-screen bg-background">
      <aside className="hidden w-64 flex-col border-r border-border bg-card md:flex">
        <div className="flex h-16 items-center border-b border-border px-6">
          <span className="text-lg font-semibold text-foreground">Преподаватель</span>
        </div>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-14 items-center gap-4 border-b border-border bg-card px-4 md:hidden">
          <span className="font-semibold text-foreground">Преподаватель</span>
